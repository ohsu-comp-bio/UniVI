...
df = d
colorDict = { 'B':'#1f77b4','CD4 T':'#ff7f0e','CD8 T':'#2ca02c','DC':'#d62728','Mono':'#9467bd','NK':'#8c564b','other':'#e377c2','other T':'#7f7f7f' }


sankey(df['true'],df['predicted'],aspect=20,colorDict=colorDict,fontsize=10)
...
def sankey(left, right, leftWeight=None, rightWeight=None, colorDict=None,
           ...
           fontsize=12, figureName=None, closePlot=False, size_inches=(3,3)):
    '''
