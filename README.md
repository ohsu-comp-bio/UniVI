...
> Note: Make sure to use the appropriate modality decoder distribution in step 3 for your specific data 
> preprocessing steps. See Step 3 `ModalityConfig` `likeliehood` input notes for more details.
