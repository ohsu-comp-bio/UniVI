...
class PrepAnnDataRNA:
    ...
    def _filter_out_cells_genes(self):
        ...
        # THIS IS GIVING A WARNING 4/29/2024:
        # /home/groups/precepts/ashforda/anaconda3/envs/UniVI_working_environment_v2/lib/python3.8/site-packages/
        # scanpy/preprocessing/_simple.py:140: ImplicitModificationWarning: Trying to modify attribute `.obs` of 
        # view, initializing view as actual.
